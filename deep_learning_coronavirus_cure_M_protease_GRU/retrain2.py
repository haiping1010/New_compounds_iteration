...
config['model_weight_filename'] = 'experiments/2019-12-23/GRU_Chem/checkpoints/GRU_Chem-baseline-model-full.hdf5'
config['finetune_data_filename'] = './generated_data/retrain2.smi'
#print(config)
...
finetuner.finetune()
finetuner.model.save_weights('experiments/2019-12-23/GRU_Chem/checkpoints/finetuned_gen2.hdf5')

config = process_config('experiments/2019-12-23/GRU_Chem/config.json')

config['model_weight_filename'] = 'experiments/2019-12-23/GRU_Chem/checkpoints/finetuned_gen2.hdf5'
modeler = GRUChem(config, session='generate')
generator = GRUChemGenerator(modeler)
#print(config)
...
import pandas as pd
training_data = pd.read_csv('./generated_data/retrain2.smi', header=None)
...
with open('./generations/gen_3.smi', 'w') as f:
