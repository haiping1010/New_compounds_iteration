...
config['model_weight_filename'] = 'experiments/2019-12-23/GRU_Chem/checkpoints/finetuned_gen' +'3.hdf5'
...
finetuner.finetune()
finetuner.model.save_weights('experiments/2019-12-23/GRU_Chem/checkpoints/finetuned_gen3.hdf5')

config = process_config('experiments/2019-12-23/GRU_Chem/config.json')
config['model_weight_filename'] = 'experiments/2019-12-23/GRU_Chem/checkpoints/finetuned_gen' +'3.hdf5'
config['finetune_data_filename'] = './generated_data/retrain.smi'

config['model_weight_filename'] = 'experiments/2019-12-23/GRU_Chem/checkpoints/finetuned_gen3.hdf5'
modeler = GRUChem(config, session='generate')
generator = GRUChemGenerator(modeler)
#print(config)
