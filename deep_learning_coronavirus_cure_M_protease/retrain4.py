...
config['model_weight_filename'] = 'experiments/2019-12-23/LSTM_Chem/checkpoints/finetuned_gen' +'4.hdf5'
config['finetune_data_filename'] = './generated_data/retrain4.smi'
#print(config)
...
finetuner.finetune()
finetuner.model.save_weights('experiments/2019-12-23/LSTM_Chem/checkpoints/finetuned_gen4.hdf5')

config = process_config('experiments/2019-12-23/LSTM_Chem/config.json')
config['model_weight_filename'] = 'experiments/2019-12-23/LSTM_Chem/checkpoints/finetuned_gen' +'4.hdf5'
#config['finetune_data_filename'] = './generated_data/retrain.smi'

config['model_weight_filename'] = 'experiments/2019-12-23/LSTM_Chem/checkpoints/finetuned_gen4.hdf5'
modeler = LSTMChem(config, session='generate')
generator = LSTMChemGenerator(modeler)
#print(config)
...
import pandas as pd
training_data = pd.read_csv('./generated_data/retrain4.smi', header=None)
...
with open('./generations/gen_04.smi', 'w') as f:
